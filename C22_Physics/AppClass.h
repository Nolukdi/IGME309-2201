...
namespace Simplex
{
	...
	private:
		String m_sProgrammer = "Alex Di Filippo - ald1289@rit.edu"; //programmer
		...
		//Sets up start and target
		int startIndexI, startIndexJ, targetIndexI, targetIndexJ;

		//Visited and open
		std::vector<AStar*> open = std::vector<AStar*>();
		std::vector<AStar*> closed = std::vector<AStar*>();
		bool cont = true;
		int collision = 0;
